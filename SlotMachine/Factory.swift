...
class Factory {
    ...
    //This is a class function, not an instance function. A class function we call on the FactoryClass and not an instance of the Factory. If we don't ever need to create an instance of this we can use a class function.
    class func createSlots() -> [[Slot ]]{
        
        //we can't access properties inside a class function so these have to be defined inside the class function, if this was not a class function they could be defined outside the scope of the function.
        let kNumberOfSlots = 3
        let kNumberOfContainers = 3
        
        //our slots array looks like this slots = [[slot1, slot2], [slot3, slot4, slot6], [slot6]]
        // mySlotArray = slot[0]
        //slot = mySlotArray[1]
        //it's an array of arrays, i.e. a 2D Array
        //in the end the data structure will look like this slots = [[slot1, slot2. slot3], [slot4, slot5, slot6], [slot7, slot8, slot9]]
        var slots: [[Slot]] = []
