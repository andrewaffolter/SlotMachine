...
//  SlotMachine
//
//  Created by Andrew Affolter on 3/15/15.
...
class SlotBrain{
    ...
    //this function reorganizes the columns into rows. We need them in rows to compute winnings.
